...
cd asset-management-on-angular
```
...
To install the dependencies in this project just use
...
asset-management-on-angular changes this location through the `.bowerrc` file.  Putting it in the app folder makes
